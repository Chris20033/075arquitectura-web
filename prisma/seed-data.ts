...
export async function seedDatabase(
  ...
  const images = [
    ...
    },
    {
      ...
      cloudinaryAssetId: "demo-asset-patio-cover",
      cloudinaryPublicId: "075arquitectura/demo/patio-tierra-cover",
      cloudinaryVersion: 1n,
      secureUrl: "https://example.invalid/cloudinary/patio-tierra-cover.jpg",
      format: "jpg",
      width: 1448,
      height: 1086,
      bytes: 356504n,
    ...
    {
      projectId: patioProject.id,
      cloudinaryAssetId: "demo-asset-patio-gallery",
      cloudinaryPublicId: "075arquitectura/demo/patio-tierra-gallery",
      cloudinaryVersion: 1n,
      secureUrl: "https://example.invalid/cloudinary/patio-tierra-gallery.jpg",
      format: "jpg",
      width: 1536,
      height: 1024,
      bytes: 240438n,
    ...
    },
    {
      ...
      cloudinaryAssetId: "demo-asset-umbral-cover",
      cloudinaryPublicId: "075arquitectura/demo/casa-umbral-cover",
      cloudinaryVersion: 1n,
      secureUrl: "https://example.invalid/cloudinary/casa-umbral-cover.jpg",
      format: "jpg",
      width: 1536,
      height: 1024,
      bytes: 230584n,
    ...
    {
      projectId: thresholdProject.id,
      cloudinaryAssetId: "demo-asset-umbral-gallery",
      cloudinaryPublicId: "075arquitectura/demo/casa-umbral-gallery",
      cloudinaryVersion: 1n,
      secureUrl: "https://example.invalid/cloudinary/casa-umbral-gallery.jpg",
      format: "jpg",
      width: 1122,
      height: 1402,
      bytes: 211158n,
